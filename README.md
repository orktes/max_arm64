...
3. Retrieve the APK and OBB files from your Android device. If you don't have an Android device or you are running a a too new Android version, you can use an emulator like [BlueStacks 5](https://www.bluestacks.com/bluestacks-5.html) and [set your Android version to an older one](https://support.bluestacks.com/hc/en-us/articles/360058931031-How-to-utilize-the-different-Android-versions-available-on-BlueStacks-5). You can use a apk extractor app or connect your device to a computer and copy the files directly. Many ways to achieve this so just google it.
